...
export default function Body() {
    return (
        <div className="" >
            ...
            <div className="md:h-[400px] lg:h-[600px] xl:h-[800px]">
                <div>
                    Previous Rides
                </div>
            </div>
            <div className="flex justify-around md:h-[400px] lg:h-[600px] xl:h-[850px] items-center bg-black text-white">
                ...
                <TextWithButton title={"Join Our Riding Community"} text={"Hello World!"} stext={"Ready To Join the SFU Cycling Club?"} link={link} linkName={"Discord"} />
            </div>
        </div>
    )
}