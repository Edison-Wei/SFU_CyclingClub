function RouteSuggestionDeletetionModal({ routeinfo, setShowDeletionModal, handleDeleteRoute }) {
    const handleClose = () => {
            ...
            <div className="ml-4 bg-white border-2 border-primary-red rounded-md">
                <div className="rounded-lg p-4 md:p-6 lg:p-8 shadow-xl text-center">
                    ...
                    <div className="flex justify-around p-2 text-[12px] md:text-[15px] lg:text-[20px]">
                        <button onClick={() => handleDeleteRoute(routeinfo.sid)} className="p-1.5 rounded-md underline underline-offset-2 bg-red-500 hover:bg-primary-red">Delete Route</button>
...
export default RouteSuggestionDeletetionModal;